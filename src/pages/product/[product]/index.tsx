  ...
  return (
    data && (
      <MaxWidthWrapper className="bg-white">
        ...
        <div className="pb-6">
          <h3 className="mt-8 border-b pb-2 text-2xl font-semibold text-primary tracking-tight">
            Overview
          </h3>
          <div
            className="leading-7 [&:not(:first-child)]:mt-5"
            dangerouslySetInnerHTML={{
              __html: product?.short_description ?? "",
            }}
          />
          ...
          <div className="leading-7 [&:not(:first-child)]:mt-5 text-accent-foreground">
